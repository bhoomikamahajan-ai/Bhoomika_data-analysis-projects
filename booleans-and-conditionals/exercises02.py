...
#    Else if computer_status_code is 400, print "Success! Computer online."
...
# c) If shuttle_speed is > 17,500, print "ALERT: Escape velocity reached!" 
#    Else if shuttle_speed is < 8000, print "ALERT: Cannot maintain orbit!" 
