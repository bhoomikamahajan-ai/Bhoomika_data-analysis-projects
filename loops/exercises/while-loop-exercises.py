...
while number_of_astronauts <=0 and number_of_astronauts > 7:
...
while starting_fuel_level - 100 * number_of_astronauts >= 0:
  altitude_shuttle_reaches += 50
  starting_fuel_level -= 100 * number_of_astronauts
  print("The shuttle gained an altitude of" altitude_shuttle_reaches km "and has" starting_fuel_level "kg of fuel left.")
